      ...
      <main className="overflow-hidden">
        ...
        >
          <h1>
            ...
            paysagère, structurelle et sociale tout en intégrant des principes
            de résilience sismique et climatique.
          </h1>
        </div>
        ...
        <main className="font-roboto mx-40 mt-20 text-xl max-lg:mx-0">
          ...
          <div className="flex flex-col items-center">
            <div className="max-lg:mx-5">
              ...
              <h2>
                ...
                structurant le village, assurant ainsi stabilité et continuité
                des circulations.
              </h2>
              <br />
              <h2 className="mb-5">
          ...
          <div className="mt-20 flex flex-col items-center">
            ...
            <div className="max-lg:mx-5">
              ...
              <br />
              <h1 className="mb-5">
                Une ombrière en bois, inspirée des techniques locales
                d'assemblage protège cet espace, favorisant un nouvel usage
                collectif.
              </h1>
            </div>
          ...
          <div className="mt-20 flex flex-col items-center">
            ...
            <div className="max-lg:mx-5">
              <h1>
                ...
                <span className="font-bold">nouvelle école</span> en pisé armé
                est conçue pour offrir un cadre sécurisé et thermiquement
                adapté.
              </h1>
              <br />
              <h1 className="mb-5">
                Le bâtiment joue avec les matériaux locaux - pierre, bois, terre
                - et intègre des stratégies climatiques telles que des murs
                épais, un patio central ombragé et des ouvertures favorisant la
          ...
          <div className="mt-20 flex flex-col items-center">
            ...
            <div className="max-lg:mx-5">
              ...
              <h1 className="mb-5">
                ...
                chicane assurent une transition thermique et préservent
                l'intimité des habitants.
              </h1>
            </div>
            <div className="max-lg:mx-2">
              <img
                src={logement}
                alt="Planche Logement"
                className="h-[850px]"
              />
            </div>
          </div>
