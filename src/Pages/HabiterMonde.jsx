  ...
  return (
    <div className="overflow-hidden">
      <Helmet>
        ...
        <title>Habiter le Monde | Ines Andaloussi </title>

        <meta
          name="description"
          content="Découvrez le projet 'Habiter le Monde', réalisé par Ines Benbrahim Andaloussi."
        />
        ...
        <meta
          property="og:title"
          content="Habiter le Monde | Ines Andaloussi"
        />
        <meta
